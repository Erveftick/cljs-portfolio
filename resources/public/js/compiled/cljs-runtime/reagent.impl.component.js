...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23153 = c;
var G__23153__$1 = (((G__23153 == null))?null:G__23153.prototype);
if((G__23153__$1 == null)){
return null;
} else {
return G__23153__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23154 = c;
var G__23154__$1 = (((G__23154 == null))?null:G__23154.prototype);
if((G__23154__$1 == null)){
return null;
} else {
return G__23154__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__23167 = c;
var G__23167__$1 = (((G__23167 == null))?null:G__23167.constructor);
if((G__23167__$1 == null)){
return null;
} else {
return G__23167__$1.displayName;
}
})();
...
var G__23169 = c;
var G__23169__$1 = (((G__23169 == null))?null:G__23169.constructor);
if((G__23169__$1 == null)){
return null;
} else {
return G__23169__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__23170 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23171 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23171);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23170);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__23172 = key;
var G__23172__$1 = (((G__23172 instanceof cljs.core.Keyword))?G__23172.fqn:null);
switch (G__23172__$1) {
...
var c = this;
var G__23206_23262 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23206_23262 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23206_23262);
}
...
var renders_23263 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23264 = cljs.core.first(cljs.core.vals(renders_23263));
...
if((cljs.core.count(renders_23263) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23263))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23264)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23264], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__23245 = o;
reagent.impl.component.goog$module$goog$object.set(G__23245,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__23246 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23247 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23247);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23246);
}});
...
var vec__23248 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23248,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23248,(1),null);
...
var G__23251 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__23251 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__23251);
}
});
}),[]);
