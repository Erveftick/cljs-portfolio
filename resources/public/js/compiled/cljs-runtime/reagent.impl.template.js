...
var G__23273 = o;
reagent.impl.template.goog$module$goog$object.set(G__23273,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__23274 = o;
reagent.impl.template.goog$module$goog$object.set(G__23274,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__23275 = props;
var G__23275__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23275,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23275);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23275__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23278 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23278,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23278;
}
})(),id_class);
...
var G__23280 = (cljs.core.count(argv) - first_child);
switch (G__23280) {
case (0):
...
var vec__23283 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23283,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23283,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23283,(2),null);
...
var temp__5808__auto___23317 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___23319 = reagent.impl.util.react_key_from_vec(v);
...
var temp__5808__auto___23322 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23322 == null)){
} else {
var key_23323 = temp__5808__auto___23322;
(jsprops.key = key_23323);
}
...
var temp__5808__auto___23330 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23330 == null)){
} else {
var key_23331 = temp__5808__auto___23330;
(jsprops.key = key_23331);
}
...
var temp__5808__auto___23333 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23333 == null)){
} else {
var key_23335 = temp__5808__auto___23333;
(jsprops.key = key_23335);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23287_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23287_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23292 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23292,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23292,(1),null);
...
break;
default:
var G__23343 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
