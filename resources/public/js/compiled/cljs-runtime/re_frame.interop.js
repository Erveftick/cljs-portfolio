...
return [(function (){var pred__23478 = cljs.core.instance_QMARK_;
var expr__23479 = reactive_val;
if(cljs.core.truth_((pred__23478.cljs$core$IFn$_invoke$arity$2 ? pred__23478.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23479) : pred__23478.call(null,reagent.ratom.RAtom,expr__23479)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23478.cljs$core$IFn$_invoke$arity$2 ? pred__23478.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23479) : pred__23478.call(null,reagent.ratom.RCursor,expr__23479)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23478.cljs$core$IFn$_invoke$arity$2 ? pred__23478.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23479) : pred__23478.call(null,reagent.ratom.Reaction,expr__23479)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23478.cljs$core$IFn$_invoke$arity$2 ? pred__23478.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23479) : pred__23478.call(null,reagent.ratom.Track,expr__23479)))){
return "tr";
} else {
return "other";
}
