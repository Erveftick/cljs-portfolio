...
var o12521 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12521["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12522 = temp__5802__auto____$1;
return (o12522["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12170__auto__ = f;
return (o__12170__auto__["toString"]).call(o__12170__auto__);
} else {
return "";
}
}catch (e12523){var _ = e12523;
return "";
}});
...
try{var o__12170__auto___12765 = t;
(o__12170__auto___12765["cljs$lang$ctorPrWriter"]).call(o__12170__auto___12765,t,writer);
}catch (e12550){var __12766 = e12550;
}
...
var char_code = (function (){var o__12170__auto__ = (new String(char$));
return (o__12170__auto__["charCodeAt"]).call(o__12170__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12170__auto__ = String;
return (o__12170__auto__["fromCharCode"]).call(o__12170__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12574 = num_code;
switch (G__12574) {
case (1):
return (185);
...
var o__12170__auto__ = String;
return (o__12170__auto__["fromCharCode"]).call(o__12170__auto__,superscript_code);
});
/**
...
}catch (e12587){var _e__12189__auto__ = e12587;
return false;
}})())){
...
var vec__12591 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12591,(0),null);
...
var i__5770__auto___12802 = (0);
while(true){
if((i__5770__auto___12802 < len__5769__auto___12800)){
args__5775__auto__.push((arguments[i__5770__auto___12802]));

var G__12804 = (i__5770__auto___12802 + (1));
i__5770__auto___12802 = G__12804;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12608){
var vec__12609 = p__12608;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12609,(0),null);
...
var G__12811 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12812 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12811;
remaining_tokens = G__12812;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12606){
var G__12607 = cljs.core.first(seq12606);
var seq12606__$1 = cljs.core.next(seq12606);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12607,seq12606__$1);
}));
...
var vec__12618 = cljs.core.split_with((function (p1__12617_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12617_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12618,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12618,(1),null);
...
var vec__12625 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12625,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12816 = cljs.core.rest(remaining_tokens);
var G__12817 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12816;
name_tokens = G__12817;
continue;
} else {
...
var vec__12630 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12630,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12630,(1),null);
var vec__12633 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12633,(1),null);
var vec__12636 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12636,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12636,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12636,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12636,(3),null);
...
var vec__12644 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12644,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12647 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12647,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12647,(1),null);
var vec__12650 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12650,(0),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12662 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12662) : devtools.munging.parse_fn_info_deep.call(null,G__12662));
})()));
}
} else {
return fn_info;
...
var G__12846 = (arity + (1));
var G__12847 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12670,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12670,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12685_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12685_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12686_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12686_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12857 = arguments.length;
var i__5770__auto___12858 = (0);
while(true){
if((i__5770__auto___12858 < len__5769__auto___12857)){
args__5775__auto__.push((arguments[i__5770__auto___12858]));

var G__12859 = (i__5770__auto___12858 + (1));
i__5770__auto___12858 = G__12859;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12692){
var vec__12693 = p__12692;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12693,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12690){
...
var o__12170__auto__ = f;
return (o__12170__auto__["getBasis"]).call(o__12170__auto__);
});
/**
...
}catch (e12727){var _e__12189__auto__ = e12727;
...
var G__12874 = (obj[cljs.core.first(path)]);
var G__12875 = cljs.core.rest(path);
obj = G__12874;
path = G__12875;
continue;
} else {
...
var _STAR_ = (function (accum,p__12728){
var vec__12729 = p__12728;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12729,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12729,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12739){
var vec__12743 = p__12739;
...
var post_process = (function (p__12751){
var vec__12753 = p__12751;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12753,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12753,(1),null);
...
return (obj[cljs.core.first(p1__12747_SHARP_)]);
}),sorted_matches);
