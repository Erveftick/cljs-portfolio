...
var G__12867 = devtools.prefs.pref(v);
v = G__12867;
continue;
} else {
return v;
...
}catch (e12796){var _e__12189__auto__ = e12796;
return false;
}})();
...
}catch (e12801){var _e__12189__auto__ = e12801;
return false;
}})();
...
}catch (e12807){var _e__12189__auto__ = e12807;
return false;
}}
}
});
...
var vec__12837 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12837,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12837,(1),null);
...
return cljs.core.some((function (p1__12848_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12848_SHARP_);
}),template);
});
