...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq15483){
var G__15485 = cljs.core.first(seq15483);
var seq15483__$1 = cljs.core.next(seq15483);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15485,seq15483__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq15487){
var G__15488 = cljs.core.first(seq15487);
var seq15487__$1 = cljs.core.next(seq15487);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15488,seq15487__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq15489){
...
var init = (function (){var G__15501 = kind;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15501__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq15498){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15499,G__15500,seq15498__$2);
}));
...
var iter__5523__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__15549(s__15550){
...
var vec__15555 = cljs.core._nth(c__5521__auto__,i__15551);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15555,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__15552,id);

var G__15586 = (i__15551 + (1));
i__15551 = G__15586;
continue;
} else {
var G__15587 = (i__15551 + (1));
i__15551 = G__15587;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15552),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__15549(cljs.core.chunk_rest(s__15550__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15552),null);
}
} else {
var vec__15558 = cljs.core.first(s__15550__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15558,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15558,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__15549(cljs.core.rest(s__15550__$2)));
} else {
var G__15588 = cljs.core.rest(s__15550__$2);
s__15550__$1 = G__15588;
continue;
}
}
} else {
