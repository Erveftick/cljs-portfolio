...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15472 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15472(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15473 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15473(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15477 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15477(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15478 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15478(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15486 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15486(reader);
}
});
...
var G__15566 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15567 = s.append(c);
c = G__15566;
s = G__15567;
continue;
}
