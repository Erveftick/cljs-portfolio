...
var len__5769__auto___13011 = arguments.length;
var i__5770__auto___13012 = (0);
while(true){
if((i__5770__auto___13012 < len__5769__auto___13011)){
args__5775__auto__.push((arguments[i__5770__auto___13012]));

var G__13014 = (i__5770__auto___13012 + (1));
i__5770__auto___13012 = G__13014;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12879){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12880,G__12881,seq12879__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12906_SHARP_){
return (!((cljs.core.meta(p1__12906_SHARP_) == null)));
})))){
...
}catch (e12977){var _e__12189__auto__ = e12977;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12979){var _e__12189__auto__ = e12979;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12985 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12986 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12986);
...
var map__12988 = opts;
var map__12988__$1 = cljs.core.__destructure_map(map__12988);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12988__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12985);
}});
...
var _STAR_print_level_STAR__orig_val__12996_13049 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12997_13050 = managed_print_level_13048;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12997_13050);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12992_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12992_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12996_13049);
}} else {
job_fn();
}
